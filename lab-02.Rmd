...
author: "Team Name: Ivy, Seyara, Jacob, Manya, Navya and Doga"
date: "`r Sys.Date()`"
...
=======
  plastic_data_all %>%
    mutate(total_mismanage_plastic = (mismanaged_plastic) * (population)) %>%
    count(region)
>>>>>>> ad022e430e627abe0bbcb3bed73be26a012c64ad
```
...
plastic_data_all %>%
  group_by(region) %>%
  summarise(median_pct_ocean = median(pct_mismanaged_plastic_ocean))
